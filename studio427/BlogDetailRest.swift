...
class BlogDetailRest: NSObject, NSURLConnectionDataDelegate {
    
    var blogDetailController:BlogDetailController!;
    ...
    func getData(id:String){
        ...
        ///地址
        var strURL = "http://427studio.net/api/blog/" + id
    ...
    func connectionDidFinishLoading(connection: NSURLConnection) {
        ...
        blogDetailController.setWebViewContent(html);
    }
